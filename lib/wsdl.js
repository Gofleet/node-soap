...
WSDL.prototype.xmlToObject = function(xml) {
  ...
  p.onopentag = function(node) {
    ...
    if (topSchema && !topSchema[name] && !topSchema[name + '[]'] && topSchema.description instanceof Function)
      topSchema = topSchema.description(self.definitions, xmlns);
  ...
  p.onclosetag = function(nsName) {
    ...
    if (topSchema && topSchema[name + '[]']) {
      ...
      var type = splitNSName(cur.schema).name;
